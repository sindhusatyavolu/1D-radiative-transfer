...
#define PI 3.1415
#endif
#define cellsize 78.125
#define boxsize 160000.0
...
FILE *myFile,*myFile2, *myFile3;
    myFile = fopen("LOS12_nh.txt", "r");
    myFile2 = fopen("LOS12_nh1.txt", "r");
    myFile3 = fopen("LOS12_T.txt", "r");
...
/* Initial values*/
	...
	//printf("%d\n",i);
	nh[i] = nharr[i];//1e-3;
	nh2[i][0] = nh[i]- nh1arr[i];//x_min_fix*nh[i];
...
t = clock() - t;
 ...
 FILE *fptr = fopen("./los12_10Myr.txt","w");
...
*/
    ...
    {
      double fac = -alpha*Ng/(pow(3e21,3)*13.6);
      double R = (1+l)*cellsize;
      double vol = 1.0/(4*PI*R*R*cellsize);
      double fh = fac*1.6e-12;

      fprintf(fptr,"%lf %0.12e %0.12e %0.12e %0.12e %0.12e %0.12e %0.12e %0.12e %0.12e %0.12e %0.12e\n", (double)l*cellsize+cellsize,(nh[l]-nh2[l][storej])/nh[l],T[l][storej],nhe1[l][storej]/((Y/(4*(1-Y))*nh[l])),nhe2[l][storej]/((Y/(4*(1-Y))*nh[l])),nhe3[l][storej]/((Y/(4*(1-Y))*nh[l])),fac*vol*Gamma(NH[l][storej],NHe1[l][storej],NHe2[l][storej],(nh[l]-nh2[l][storej]),nhe1[l][storej],nhe2[l][storej])/(nh[l]-nh2[l][storej])
        ,fac*vol*Gammahe1(NH[l][storej],NHe1[l][storej],NHe2[l][storej],(nh[l]-nh2[l][storej]),nhe1[l][storej],nhe2[l][storej])/(nhe1[l][storej]),
        fac*vol*Gammahe2(NH[l][storej],NHe1[l][storej],NHe2[l][storej],(nh[l]-nh2[l][storej]),nhe1[l][storej],nhe2[l][storej])/(nhe2[l][storej]),
        fh*vol*Heat(NH[l][storej],NHe1[l][storej],NHe2[l][storej],(nh[l]-nh2[l][storej]),nhe1[l][storej],nhe2[l][storej])/(nh[l]-nh2[l][storej]),
        fh*vol*Heat2(NH[l][storej],NHe1[l][storej],NHe2[l][storej],(nh[l]-nh2[l][storej]),nhe1[l][storej],nhe2[l][storej])/nhe1[l][storej],
        fh*vol*Heat3(NH[l][storej],NHe1[l][storej],NHe2[l][storej],(nh[l]-nh2[l][storej]),nhe1[l][storej],nhe2[l][storej])/nhe2[l][storej]);
